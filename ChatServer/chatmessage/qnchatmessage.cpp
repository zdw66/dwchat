...
void QNChatMessage::setText(QString text, QString time, QSize allSize, QNChatMessage::User_Type userType,bool check)
{
    m_msg = text;
    m_userType = userType;
    m_time = time;
...
QSize QNChatMessage::fontRect(QString str,bool is_images)
{
    m_msg = str;
    int minHei = 30;
    int iconWH = 40;
